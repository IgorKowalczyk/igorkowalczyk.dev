...
import { ExternalLinkIcon, LaptopIcon, MoonIcon, RefreshCwIcon, SettingsIcon, SparklesIcon, SunIcon, SunMoonIcon } from "lucide-react";
 ...
 return (
  <div className="mt-2 divide-y divide-black/10 dark:divide-white/10">
   <div className="flex w-full cursor-auto items-center py-3 text-base text-neutral-800 select-none dark:text-white">
    <SunMoonIcon className="mr-2 size-5" />
    Theme
   ...
   {isMobile ? (
    <Drawer shouldScaleBackground={true} direction="bottom" open={isOpen} onOpenChange={() => setIsOpen(!isOpen)}>
     <DrawerContent variant="bottom">
      <DrawerHeader>
       <DrawerTitle>
        <SettingsIcon className="size-6 text-neutral-800 dark:text-white" /> Settings
       </DrawerTitle>
    ...
    <Dialog open={isOpen} onOpenChange={() => setIsOpen(false)}>
     <DialogContent>
      <DialogHeader>
       <DialogTitle>
        <SettingsIcon className="size-6 text-neutral-800 dark:text-white" />
        Settings
       </DialogTitle>
